...
String mailContents = ""
	...
	+"<tr>"
	+"	<td>이미지</td>"
	+"	<td><img alt=\"\" src=\"http://www.ikosmo.co.kr/images/common/logo_center_v2.jpg\"></td>"
	+"</tr>"
...
<table border=1>
	<tr>	
		<td> 
			보내는사람 : 
			<input type="text" name="from" value="gkrwns1014@naver.com" />
		</td>
	</tr>
	<tr>	
		<td>
			받는사람 : 
			<input type="text" name="to" value="wol02095@gmail.com" />
		</td>
	</tr>
	<tr>	
		<td>
