...
페이지를 방문하면 레이어 팝업이 뜨게 됩니다. <br />
<%
String isPopup = "on";//on 상태일때 팝업이 열린다.
//생성된 모든 쿠키를 가져온다.
...
if(cookies!=null){
   for(Cookie c : cookies){
      ...
      String cookieValue = c.getValue();
    	//쿠키명 중 팝업 닫기 관련 항목이 있다면 저장된 값을 가져온다.
...
%>
   ...
   function popClose(){
      ...
      /*
       	오늘 하루열지않음 체크박스를 체크한후 닫기를 누르면
       	JS를 통해 폼값을 전송한다. target을iframe으로
       	설정하여 페이지 이동이없는것(비동기)처럼 보이게 한다.
      */
