...
/*
	...
	:운영체제별로 서버의 물리적 경로는 다르기떄문에 파일이 업로드되는
...
/* 
	...
	: 만약 파일이 여러개 업로드 된다면 각각의 용량을 합친용량이
	최대용량이 된다.
	EX) 500Kb * 2  = 1000Kb
*/
...
/*
	...
	Ex) apple.png, apple1.png, ...와 같이 인덱스르 부여한다.
*/
FileRenamePolicy policy = new DefaultFileRenamePolicy();

//멀티파트객체 생성및 전송된 폼값을 저장하기 위한 변수 선언
